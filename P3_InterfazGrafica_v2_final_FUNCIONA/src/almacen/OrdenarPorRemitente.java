...
public class OrdenarPorRemitente implements Comparator<IMensajeCorreo>,Serializable {
	private static final long serialVersionUID = 1L;

	/**
	 *==English== 
	 * This method is created to implement an order criteria. First by sender.
	 *==Spanish==
	 * Metodo creado para implementar un criterio de ordenación: primero por el campo remitente en sentido ascendente,
	 * en segundo lugar en caso de igualdad ordenación por la fecha en sentido descendente, y así sucesivamente por el
